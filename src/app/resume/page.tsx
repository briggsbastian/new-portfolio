    ...
    <div className="relative min-h-screen overflow-hidden bg-gray-900 text-white">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-16 space-y-16">
        ...
        <header className="text-center space-y-4">
          <h1 className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-purple-500">
            Briggs Bastian
          </h1>
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <div className="flex-1 space-y-6">
            ...
            <div className="bg-white/10 backdrop-blur-lg border border-white/20 p-6 rounded-xl space-y-2">
              <h3 className="text-xl font-semibold text-purple-500">Kraft Kennedy</h3>
            ...
            <div className="bg-white/10 backdrop-blur-lg border border-white/20 p-6 rounded-xl space-y-2">
              <h3 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-yellow-500 rounded-lg">McDonald's Crew Member</h3>
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="bg-white/10 backdrop-blur-lg border border-white/20 p-4 rounded-xl space-y-2">
              <h3 className="font-semibold text-teal-300">SIEM / IDS</h3>
              <p className="text-gray-200">ConnectWise SIEM, Wazuh, BlackPoint, Microsoft Sentinel</p>
            </div>

            <div className="bg-white/10 backdrop-blur-lg border border-white/20 p-4 rounded-xl space-y-2">
              <h3 className="font-semibold text-teal-300">EDR</h3>
              <p className="text-gray-200">SentinelOne, Microsoft Defender for Endpoint</p>
            </div>

            <div className="bg-white/10 backdrop-blur-lg border border-white/20 p-4 rounded-xl space-y-2">
              <h3 className="font-semibold text-teal-300">DNS</h3>
              <p className="text-gray-200">Atakama, Cisco Umbrella/OpenDNS</p>
            </div>

            <div className="bg-white/10 backdrop-blur-lg border border-white/20 p-4 rounded-xl space-y-2">
              <h3 className="font-semibold text-teal-300">Email Hygiene</h3>
              <p className="text-gray-200">Mimecast, Barracuda, Tessian</p>
            </div>

            <div className="bg-white/10 backdrop-blur-lg border border-white/20 p-4 rounded-xl space-y-2">
              <h3 className="font-semibold text-teal-300">Security Awareness Training</h3>
              <p className="text-gray-200">KnowBe4, BreachSecureNow</p>
            </div>

            <div className="bg-white/10 backdrop-blur-lg border border-white/20 p-4 rounded-xl space-y-2">
              <h3 className="font-semibold text-teal-300">Networking Infrastructure</h3>
              <p className="text-gray-200">
            ...
            <div className="bg-white/10 backdrop-blur-lg border border-white/20 p-4 rounded-xl space-y-2">
              <h3 className="font-semibold text-teal-300">Operating Systems</h3>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white/10 backdrop-blur-lg border border-white/20 p-6 rounded-xl space-y-2">
            <h3 className="text-xl font-semibold">UCSD Cybersecurity Bootcamp</h3>
            <p className="text-gray-300">2021</p>
          </div>
          <div className="bg-white/10 backdrop-blur-lg border border-white/20 p-6 rounded-xl space-y-2">
            <h3 className="text-xl font-semibold">Simi Valley High School</h3>
